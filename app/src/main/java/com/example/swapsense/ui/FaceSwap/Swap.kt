...
class Swap {
    ...
    companion object {
        ...
        // Flag to check if OpenCV is initialized
        private var openCvInitialized = true

        // Static initializer to load OpenCV libraries
        init {
        ...
        // Public function to perform face swapping on two bitmaps
        fun faceSwapAll(
            ...
            if (openCvInitialized) {
                ...
                // TODO
                // Perform the swap on the first set of detected landmarks (use swapSingle)
                // get matrix with swap
                // Convert the processed Mat back to Bitmap and return it

            }
            return bmp2
        }

        // Private function to swap faces between two images
        private fun swapSingle(
            ...
            // Clone the second image to warp the first image onto
